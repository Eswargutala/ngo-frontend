...
export function ContactSection({ contactInfo, form, socialMedia }: ContactSectionProps) {
  ...
  const socialLinks = [
    { icon: Facebook, label: 'Facebook', url: 'https://www.facebook.com/share/1G21SW7VKr/', color: 'hover:text-[#1877F2]' },
    { icon: Twitter, label: 'Twitter', url: 'https://x.com/lakhil_ngo', color: 'hover:text-[#1DA1F2]' },
    { icon: Instagram, label: 'Instagram', url: 'https://www.instagram.com/lakhil_foundation?igsh=MTIyZ3hpYzk2bXEybA==', color: 'hover:text-[#E4405F]' },
    { icon: Linkedin, label: 'LinkedIn', url: 'https://www.linkedin.com/company/laskhil-raj-welfare-foundation/', color: 'hover:text-[#0A66C2]' },
    { icon: MessageCircle, label: 'WhatsApp', url: 'https://chat.whatsapp.com/ErFMeM9qSkWHBlkreWmGMA?mode=gi_t', color: 'hover:text-[#25D366]' },
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <a href="mailto:tech.lakhilraj@gmail.com" className="text-[14px] font-semibold text-[#111827] dark:text-[#E5E7EB] hover:text-[#1E7A6E] dark:hover:text-[#4FD1C5] transition-colors font-['Inter',sans-serif]">
                    {contactInfo.email}
                  </a>
                </div>
              </div>

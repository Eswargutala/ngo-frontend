...
interface WhyLakhilRajWelfareFoundationExistsProps {
  sectionTitle: string;
...
export function WhyLakhilRajWelfareFoundationExists({
  sectionTitle,
  problem,
  solution,
  vision,
}: WhyLakhilRajWelfareFoundationExistsProps) {
  ...
  return (
    <section
      id="why-exists"
      className="bg-white dark:bg-[#0B1F1D] py-12 md:py-16 transition-colors duration-200"
    >

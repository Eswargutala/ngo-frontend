          ...
          <div className={`space-y-4 transition-all duration-500 delay-300 ${
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-[13px] text-[#E5E7EB] font-['Inter',sans-serif] group cursor-pointer">
                ...
                <span className="group-hover:text-[#F4B400] transition-colors max-w-[200px]">H. No. 448, Hansa Mohalla, Deeg - 43 Fatehpur, Pundri, Haryana, India</span>
              </div>
              <div className="flex items-start gap-2 text-[13px] text-[#E5E7EB] font-['Inter',sans-serif] group">
                ...
                <a href="mailto:tech.lakhilraj@gmail.com" className="hover:text-[#F4B400] transition-colors">
                  tech.lakhilraj@gmail.com
                </a>
              </div>
              <div className="flex items-start gap-2 text-[13px] text-[#E5E7EB] font-['Inter',sans-serif] group cursor-pointer">
                <Phone size={16} className="mt-0.5 flex-shrink-0 group-hover:text-[#F4B400] transition-colors" />
                <span className="group-hover:text-[#F4B400] transition-colors">+91 94677 63541</span>
              </div>
            </div>
            ...
            <a 
              href="/volunteer"
              className="mt-4 border-2 border-white text-white px-5 py-2 rounded-md text-[13px] hover:bg-white hover:text-[#0F3D3A] dark:hover:text-[#0B1F1D] hover:scale-105 active:scale-95 transition-all duration-300 font-semibold font-['Inter',sans-serif] inline-block text-center"
            >
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-4">
          <div className={`flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] font-['Inter',sans-serif] transition-all duration-700 pb-20 md:pb-0 ${
            ...
            <div className="flex items-center gap-4 text-[#9CA3AF] flex-wrap justify-center order-3 md:order-3">
              <a href="/privacy-policy" className="hover:text-[#F4B400] transition-colors duration-200">
                Privacy Policy
              </a>
              <span className="text-[#9CA3AF]/50">|</span>
              <a href="/terms-conditions" className="hover:text-[#F4B400] transition-colors duration-200">
                Terms & Conditions
              </a>
              <span className="text-[#9CA3AF]/50">|</span>
              <a href="/refund-policy" className="hover:text-[#F4B400] transition-colors duration-200">

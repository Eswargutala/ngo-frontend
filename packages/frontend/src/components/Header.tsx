...
export function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-[32px] h-full flex items-center justify-between py-[0px]">
        {/* Logo with NGO Name */}
        <a
          href="/"
        ...
        {/* Desktop Nav Links */}
        <nav className="hidden lg:flex items-center gap-7 xl:gap-9" ref={dropdownRef}>
          {/* Home */}
          <a
            href="/"
          ...
          <div className="relative">
            ...
            {activeDropdown === 'about' && (
              <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-[#112F2B] rounded-lg shadow-xl border border-[#E5E7EB] dark:border-[#1F4D47] py-3 animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                >
                  {t('About LAKHIL RAJ WELFARE FOUNDATION')}
                </a>
                <a
                  href="/mission-vision"
                  className="block px-4 py-2.5 text-[13px] text-[#6B7280] dark:text-[#9CA3AF] hover:bg-[#F9FAFB] dark:hover:bg-[#1F4D47] hover:text-[#1E7A6E] dark:hover:text-[#4FD1C5] transition-colors"
                ...
                <a
                  ...
                  className="block px-4 py-2.5 text-[13px] text-[#6B7280] dark:text-[#9CA3AF] hover:bg-[#F9FAFB] dark:hover:bg-[#1F4D47] hover:text-[#1E7A6E] dark:hover:text-[#4FD1C5] transition-colors"
                >
                  {t('Team LAKHIL RAJ WELFARE FOUNDATION')}
                </a>
                <a
                  href="/team#advisory"
                  className="block px-4 py-2.5 text-[13px] text-[#6B7280] dark:text-[#9CA3AF] hover:bg-[#F9FAFB] dark:hover:bg-[#1F4D47] hover:text-[#1E7A6E] dark:hover:text-[#4FD1C5] transition-colors"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            {isAuthenticated ? (
              <a
                href={user?.isAdmin ? '/admin/dashboard' : '/my-account'}
              ...
              <div className="flex items-center">
                <a
                  href="/login"
                  className="flex items-center gap-1.5 text-[14px] text-[#1E7A6E] dark:text-[#4FD1C5] font-semibold hover:opacity-80 transition-colors px-3 py-2"
                >
                  {t('Login')}
                </a>
              </div>
      ...
      >
        <nav className="flex flex-col px-6 py-4 gap-1 max-h-[80vh] overflow-y-auto">
          ...
          <div className="border-b border-[#F3F4F6] dark:border-[#1F4D47]">
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ${
                mobileDropdown === 'involved' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
          ...
          <div className="border-b border-[#F3F4F6] dark:border-[#1F4D47]">
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ${
                mobileDropdown === 'programs' ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <div className="pl-4 pb-2 space-y-1">
                <a
          ...
          <div className="border-b border-[#F3F4F6] dark:border-[#1F4D47]">
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ${
                mobileDropdown === 'impact' ? 'max-h-[450px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <div className="pl-4 pb-2 space-y-1">
                <a
          ...
          <div className="border-b border-[#F3F4F6] dark:border-[#1F4D47]">
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ${
                mobileDropdown === 'about' ? 'max-h-[400px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <div className="pl-4 pb-2 space-y-1">
                <a
          ...
          <div className="border-b border-[#F3F4F6] dark:border-[#1F4D47]">
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ${
                mobileDropdown === 'resources' ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <div className="pl-4 pb-2 space-y-1">
                <a
          ...
          <div className="border-b border-[#F3F4F6] dark:border-[#1F4D47]">
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ${
                mobileDropdown === 'contact' ? 'max-h-80 opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <div className="pl-4 pb-2 space-y-1">
                <a
          ...
          <div className="border-b border-[#F3F4F6] dark:border-[#1F4D47]">
            {isAuthenticated ? (
              <a
                href={user?.isAdmin ? '/admin/dashboard' : '/my-account'}
                onClick={closeMobileMenu}
                className="w-full flex items-center gap-2 text-[14px] font-semibold text-[#6B7280] dark:text-[#9CA3AF] py-3 hover:text-[#1E7A6E] dark:hover:text-[#4FD1C5] transition-colors"
              >
                <User size={16} />
                {t('Account') || 'Account'}
              </a>
              ...
              <div className="flex gap-4">
                <a
                  href="/login"
                  onClick={closeMobileMenu}
                  className="w-full flex items-center gap-2 text-[14px] font-semibold text-[#1E7A6E] dark:text-[#4FD1C5] py-3 hover:opacity-80 transition-colors"
                >
                  <LogIn size={16} />
                  {t('Login')}
                </a>

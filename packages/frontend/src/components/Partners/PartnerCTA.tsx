          ...
          <div className="bg-gradient-to-br from-[#1E7A6E] to-[#0F5C52] dark:from-[#164D46] dark:to-[#0B3A33] rounded-3xl p-10 md:p-14 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative max-w-[800px] mx-auto">
              ...
              <div className="mt-10 pt-8 border-t border-white/20 text-center">
                ...
                <a href="mailto:tech.lakhilraj@gmail.com" className="text-[16px] text-white font-semibold hover:text-[#F4B400] transition-colors duration-200 font-['Inter',sans-serif]">

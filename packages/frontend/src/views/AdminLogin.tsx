...
export default function AdminLogin() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#F9FAFB] dark:bg-[#0F0F0F] flex items-center justify-center">
    ...
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-[#0F0F0F] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-[380px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[13px] text-[#6B7280] dark:text-[#9CA3AF]">Authorized access only</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#1A1A1A] rounded-lg p-8 border border-[#E5E7EB] dark:border-[#374151] shadow-sm">
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                placeholder="tech.lakhilraj@gmail.com"
          ...
          <div className="mt-6 text-center">
            <a
              href="#forgot"
              className="text-[12px] text-[#6B7280] dark:text-[#9CA3AF] hover:text-[#1E7A6E] hover:underline"
            >
              Forgot password?
            </a>
          </div>
        ...
        <div className="mt-6 text-center">
          <a
            href="/"
            className="text-[13px] text-[#6B7280] dark:text-[#9CA3AF] hover:text-[#1E7A6E] hover:underline"
          >
            ← Back to website
          </a>
        </div>

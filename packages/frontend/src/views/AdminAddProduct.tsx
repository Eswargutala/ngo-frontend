...
export default function AdminAddProduct() {
  ...
  return (
    <div className="bg-[#FAF9F7] dark:bg-[#0F0F0F]">
      {/* Sticky Top Bar */}
                ...
                <div className="space-y-2 text-[13px]">
                  {formData.brand && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-[#1F1F1F] dark:text-[#FAF9F7]">
                        {formData.brand}
                      </span>
                    </div>
                  )}
                  {formData.sku && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-[12px] text-[#1F1F1F] dark:text-[#FAF9F7]">
                        {formData.sku}
                      </span>
                    </div>
                  )}

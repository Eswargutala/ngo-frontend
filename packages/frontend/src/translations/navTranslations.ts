// Comprehensive Navigation Translations for Lakhil Raj Welfare Foundation NGO
...
export const navTranslations: Record<string, Record<Language, string>> = {
  ...
  // ABOUT US Dropdown
  'nav.about.aboutLakhil Raj Welfare Foundation': { 
  ...
  'nav.about.teamLakhil Raj Welfare Foundation': { 
    en: 'Our Team', 
    hi: 'हमारी टीम', 
    es: 'Nuestro Equipo', 
    fr: 'Notre Équipe', 
  ...
  'nav.contact.inviteSchool': { 
    en: 'Invite Lakhil Raj Welfare Foundation to Your School', 
    hi: 'संभव को अपने स्कूल में आमंत्रित करें', 
    es: 'Invita a Lakhil Raj Welfare Foundation a tu Escuela', 
    fr: 'Invitez Lakhil Raj Welfare Foundation dans votre École', 
    de: 'Lakhil Raj Welfare Foundation in Ihre Schule Einladen', 
    pt: 'Convide Lakhil Raj Welfare Foundation para sua Escola', 
    zh: '邀请Lakhil Raj Welfare Foundation到您的学校' 
  },
